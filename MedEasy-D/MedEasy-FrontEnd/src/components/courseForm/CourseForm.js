...
export const CourseForm = (props) => {
    ...
    return (
        <div className='form-container'>
            <h1>Fill Medicine Details</h1>
            <form onSubmit={formSubmitHandler}>
                <div className='error'>{errorMessage}</div>
                <div className='form-input'>
                    <input type="text" placeholder='Medicine Name' onChange={nameHandler} />
                </div>
                <div className='form-input'>
                    <input type="text" placeholder='Medicine Price' onChange={priceHandler} />
                </div>
                <div className='clearfix'></div>
                <div className='form-input'>
                    <input type="text" placeholder='Medicine Image' onChange={imageHandler} />
                </div>
                <div className='clearfix'></div>
                <div className='form-input'>
                    <input type="text" placeholder='Medicine Provider' onChange={providerHandler} />
                </div>
                <div className='clearfix'></div>
                <div className='form-input'>
                    <button className="add_course">Add Medicine</button>
                </div>
                <div className='clearfix'></div>
            </form>
        </div>
